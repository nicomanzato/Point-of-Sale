...
public class NewOrder extends JFrame {
	...
	public NewOrder() {
		...
		JLabel lblTotal = new JLabelObserver("Total: $0", newOrder);
		...
		tableOrderedProducts = new JTableOrderedProduct(newOrder);
		...
		for (Product product: products) {
			...
			JButtonProduct button = new JButtonProduct(product, newOrder);
			panel.add(button);
		}  
	}
